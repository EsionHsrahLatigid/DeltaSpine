...
namespace
{
class DeltaSpineStandaloneApplication final : public juce::JUCEApplication
{
public:
    DeltaSpineStandaloneApplication()
    {
...
START_JUCE_APPLICATION(DeltaSpineStandaloneApplication)
