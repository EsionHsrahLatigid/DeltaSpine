# DeltaSpine Verification Runbook
...
1. Run the project metadata/structure checker for JUCE identity.
...
6. Run any host smoke or plugin tester validation after the binaries exist.
...
- RMS / peak / crest / DC / activity metrics for the hostile-input set;
- final GitHub Actions CI run URL and release URL once published.

## Expected commands

```sh
python3 /Users/2bit/.codex/skills/develop-juce-plugins/scripts/check_juce_project.py /Users/2bit/prog/juce/DeltaSpine \
  --expect-product DeltaSpine \
